      ...
      <div class="p-6 space-y-6">
        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-full bg-violet-600 flex items-center justify-center text-white font-medium text-sm">
              S
            </div>
            <div>
        ...
        <!-- Hero section -->
<div class="relative overflow-hidden rounded-2xl border border-violet-100 dark:border-violet-900 bg-gradient-to-br from-violet-50 via-white to-violet-100 dark:from-violet-950 dark:via-gray-900 dark:to-violet-900 p-6 md:p-10">
  ...
  <div class="relative flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
    ...
    <div class="max-w-xl">
      ...
      <div class="flex flex-wrap gap-2 mt-4">
        <span class="text-xs px-3 py-1 rounded-full bg-violet-100 dark:bg-violet-900 text-violet-700 dark:text-violet-300">
          ⚡ No ESCOM outages
        </span>
        <span class="text-xs px-3 py-1 rounded-full bg-violet-100 dark:bg-violet-900 text-violet-700 dark:text-violet-300">
    ...
    <div class="flex-1 flex justify-center lg:justify-end">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          ...
          >
            ...
            >
              <span
                v-if="pkg.tag"
                class="absolute top-2 left-2 text-[10px] px-2 py-0.5 rounded-full text-white"
      ...
      <Teleport to="body">
        <Transition name="fade">
          ...
          >
            <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 w-full max-w-md mx-4 overflow-hidden">
              ...
              <div v-if="checkoutStep === 'pay' && currentPkg" class="p-5 space-y-4">
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg px-4 py-3 flex justify-between items-center">
                  ...
                  <div class="text-xs text-gray-400">{{ currentPlan === 'installment' ? '30% deposit' : 'Full payment' }}</div>
                </div>
                  ...
                  <div class="space-y-3">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <input v-model="cardExpiry" placeholder="MM / YY" maxlength="7" class="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white outline-none focus:border-violet-500" />
                      </div>
                      <div>
                        <label class="text-xs text-gray-400 block mb-1">CVV</label>
                        <input v-model="cardCvv" placeholder="123" maxlength="3" type="password" class="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white outline-none focus:border-violet-500" />
                      </div>
                    </div>
                    <div>
              ...
              <div v-if="checkoutStep === 'success' && currentPkg" class="p-6 text-center space-y-3">
                <div class="w-12 h-12 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center mx-auto text-green-600 dark:text-green-300 text-xl">
                  ✓
                </div>
